...
#define st506_rdgt_wrap_target 0
#define st506_rdgt_wrap 4
#define st506_rdgt_pio_version 1

static const uint16_t st506_rdgt_program_instructions[] = {
            //     .wrap_target
    0x6002, //  0: out    pins, 2
    0x602e, //  1: out    x, 14
    0x0042, //  2: jmp    x--, 2
    0x7030, //  3: out    x, 16           side 0
    0x0044, //  4: jmp    x--, 4
            //     .wrap
};

#if !PICO_NO_HARDWARE
static const struct pio_program st506_rdgt_program = {
    .instructions = st506_rdgt_program_instructions,
    .length = 5,
    .origin = -1,
    .pio_version = st506_rdgt_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config st506_rdgt_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + st506_rdgt_wrap_target, offset + st506_rdgt_wrap);
    sm_config_set_out_pin_count(&c, 2);
